...
<nav class="navbar navbar-expand-lg navbar-custom shadow">
  <div class="container d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex gap-2">
      <a class="btn btn-light btn-nav" href="${pageContext.request.contextPath}/routes/new">+ Add Route</a>
  ...
  <div class="container">
    ...
    <div class="card card-custom">
      ...
      <div class="card-header card-header-custom d-flex justify-content-between align-items-center">
        <div>
          <div class="mini-title">Route Records</div>
          <small class="text-muted">Manage route details and distance</small>
        </div>
      </div>
          ...
          <table class="table table-hover table-bordered align-middle mb-0">
            ...
            <tbody>
              <c:forEach var="r" items="${routes}">
                <tr>
                  <td class="fw-semibold">${r.routeFrom}</td>
                  <td class="fw-semibold">${r.routeTo}</td>
                  <td class="fw-bold text-primary">${r.distance} km</td>

                  <td class="d-flex gap-2">
                    <a class="btn btn-sm btn-primary btn-action"
                       href="${pageContext.request.contextPath}/routes/edit/${r.routeId}">
                      Update
                    </a>

                    <a class="btn btn-sm btn-danger btn-action"
                       href="${pageContext.request.contextPath}/routes/delete/${r.routeId}"
